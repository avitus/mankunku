...
export const PROGRESSION_TEMPLATES: Record<ChordProgressionType, ProgressionTemplate> = {
	'ii-V-I-major': {
		type: 'ii-V-I-major',
		name: 'ii-V-I Major (Short)',
		shortName: 'ii-V-I Maj',
		harmony: II_V_I_MAJOR_SHORT,
		bars: 2
	},
	'ii-V-I-minor': {
		type: 'ii-V-I-minor',
		name: 'ii-V-I Minor (Short)',
		shortName: 'ii-V-I Min',
		harmony: II_V_I_MINOR_SHORT,
		bars: 2
	},
	'ii-V-I-major-long': {
		type: 'ii-V-I-major-long',
		name: 'ii-V-I Major (Long)',
		shortName: 'ii-V-I Maj Long',
		harmony: II_V_I_MAJOR_LONG,
		bars: 8
	},
	'ii-V-I-minor-long': {
		type: 'ii-V-I-minor-long',
		name: 'ii-V-I Minor (Long)',
		shortName: 'ii-V-I Min Long',
...
export const PROGRESSION_LICK_CATEGORIES: Record<ChordProgressionType, string[]> = {
	...
	'ii-V-I-major-long': ['ii-V-I-major'],
	'ii-V-I-minor-long': ['ii-V-I-minor'],
