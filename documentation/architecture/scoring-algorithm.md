...
- **Tone, dynamics, and articulation.** The pitch detector hears the fundamental frequency, not your sound. A breathy ghost note and a fortissimo accent score the same as long as the pitch and timing land — and a ghost that lands more than half a semitone out of tune counts as the wrong note, like any other (see [Ghost notes](./audio-pipeline.md#ghost-notes)).
