...
|---|---|---|
| **Beginner Cells** | Two- and three-note minimal cells designed for difficulty levels 1–5. Pentatonic intervals, blues fragments, neighbor-tone patterns. The on-ramp into the catalog. | 50 |
