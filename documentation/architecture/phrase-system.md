...
Every phrase in the *catalog* is a real lick: hand-written entries, combinatorial phrases built by pairing a scale pattern with a rhythm pattern, and your own recorded or written licks. (Trick examples are generated, but they are drills of a formula, not catalog content — see below.) There is no algorithmic phrase generator any more — one existed, reachable only from a settings screen whose choices were discarded before a note played, and both were removed on 2026-08-09.
