...
In addition to the hand-written licks, the catalog includes about 470 phrases generated by pairing a set of **scale patterns** (sequences of scale degrees) with **rhythm templates** (durations and offsets). Only musically valid pairings — matched note counts, compatible scales — get produced.
