...
The catalog organizes its phrases into nine categories. Each category corresponds to a harmonic context.
...
Most curated licks live in the 10–75 range; the bands above 75 are mostly populated by the algorithmic generator at high difficulty levels.

The bands are also color-coded throughout the app — the lick difficulty badges, the difficulty filter pills, and the level indicator on your dashboard all use the same palette.
...
The combinatorial licks fill out the lower difficulty bands with variations the curators wouldn't have written by hand because they'd be tedious to write twenty-two times. They're labeled as combinatorial in the catalog if you want to filter them out.
