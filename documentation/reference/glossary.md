...
**Combinatorial lick** — A lick generated by pairing a scale pattern with a rhythm template. About 86 of these in the catalog, alongside the 163 hand-written ones.
...
**Pitch complexity / Rhythm complexity** — The two underlying numbers that average to your displayed level. They climb (and fall) independently based on your accuracy in each dimension. See [Levels & Difficulty](../architecture/adaptive-difficulty.md).
